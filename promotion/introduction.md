Makes QR codes on web pages clickable. Works on screens shared in Teams, Google Meet and Zoom too.
...
Webページ中のQRコードをクリックできるようになります。Teams、Google Meet、Zoomの共有画面にも対応。
